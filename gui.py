...
Button(root, text="Count of Files", width=20, command=count).grid(row=2, column=0)
...
Button(root, text="Huge PNG Convertor", width=20, command=hugepng).grid(row=4, column=1)
Button(root, text="Replace Colon", width=20, command=colonrep).grid(row=5, column=1)
Button(root, text="Find Duplicate", width=20, command=duplicate).grid(row=2, column=2)
Button(root, text="Find Similar Images", width=20, command=similar).grid(row=3, column=2)
Button(root, text="Show Stats", width=20, command=stats).grid(row=4, column=2)
Button(root, text="Top 10 Files", width=20, command=top).grid(row=5, column=2)
Button(root, text="Clear Log Output", width=20, command=clear).grid(row=2, column=3)
Button(root, text="Verify Files", width=20, command=verify).grid(row=3, column=3)
Button(root, text="Delete Backups", width=20, command=delete).grid(row=4, column=3)
